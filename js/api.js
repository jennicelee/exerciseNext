...
const tagNames = ['japan', 'anime', 'school', 'tech', 'dog', 'country', 'city'];
...
fetch('https://api.tumblr.com/v2/tagged?tag=' + tag + '&api_key=mVg3nhSchGWTKJ4fBdXun0dWPVeJ5COyQnI2HYD9DylGxBTbRm')
